	...
	<view class="container">
		<view class="tui-searchbox">
			<view class="tui-search-input">
				...
				<input confirm-type="search" placeholder="大家都在搜：伯乐购" :focus="true" auto-focus placeholder-class="tui-input-plholder"
		...
		<view v-show="key">
			<view class="tui-header" @tap="getResult(key)">
			...
			<view class="tui-result-box">
				<block v-for="(item,index) in searchResult" :key="index" >
					<view class="tui-result-item" hover-class="tui-opcity" :hover-stay-time="150"  @tap="getResult(item)" >
